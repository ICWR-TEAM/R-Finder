...
class finder:
    ...
    def check(self, path):
        ...
        try:
            ...
            port = self.args.port if self.args.port else (443 if self.args.target.split(":")[0] == "https" else 80)
    ...
    def __init__(self):
        ...
        parser.add_argument("-p", "--port", required=False, type=int, help="Specify a custom port (optional)")
